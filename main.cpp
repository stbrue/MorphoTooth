...
int main() {
    ...
    cells[0].addNeighbour(1);
    cells[0].addNeighbour(2);
    cells[0].addNeighbour(3);
    cells[0].addNeighbour(4);
    cells[0].addNeighbour(5);
    cells[0].addNeighbour(6);

    cells[1].addNeighbour(7);
    cells[1].addNeighbour(8);
    cells[1].addNeighbour(2);
    cells[1].addNeighbour(0);
    cells[1].addNeighbour(6);
    cells[1].addNeighbour(9);

    cells[2].addNeighbour(8);
    cells[2].addNeighbour(10);
    cells[2].addNeighbour(11);
    cells[2].addNeighbour(3);
    cells[2].addNeighbour(0);
    cells[2].addNeighbour(1);

    cells[3].addNeighbour(2);
    cells[3].addNeighbour(11);
    cells[3].addNeighbour(12);
    cells[3].addNeighbour(13);
    cells[3].addNeighbour(4);
    cells[3].addNeighbour(0);

    cells[4].addNeighbour(0);
    cells[4].addNeighbour(3);
    cells[4].addNeighbour(13);
    cells[4].addNeighbour(14);
    cells[4].addNeighbour(15);
    cells[4].addNeighbour(5);

    cells[5].addNeighbour(6);
    cells[5].addNeighbour(0);
    cells[5].addNeighbour(4);
    cells[5].addNeighbour(15);
    cells[5].addNeighbour(16);
    cells[5].addNeighbour(17);

    cells[6].addNeighbour(9);
    cells[6].addNeighbour(1);
    cells[6].addNeighbour(0);
    cells[6].addNeighbour(5);
    cells[6].addNeighbour(17);
    cells[6].addNeighbour(18);
    ...
    double distance3D1 = Geometrics::centerDistance3D(cells[0], cells[1]);
